...
TASK_NAME="longvid-reasoning-eval_1min"
OUTPUT_DIR="/nas2/longvideo_eval/longvid-reasoning-eval/results/qwen3vl_8b/longvid_reasoning_eval_1min"
...
$PYTHON -m accelerate.commands.launch --num_processes=${NUM_PROCESSES} -m lmms_eval \
    ...
    --log_samples \
    --log_samples_suffix qwen3_8b_1min \
